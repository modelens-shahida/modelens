...
export default function DailyJobsChart({ data }) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-lg font-semibold text-white">Daily Jobs (Last 30 Days)</h3>
      </div>
        ...
        <div className="space-y-3 max-h-64 overflow-y-auto">
          {data.map((item, index) => (
            ...
            >
              ...
              <span className="text-sm font-semibold text-yellow-300 w-12 text-right">
                {item.count}
              </span>
            </motion.div>
          ))}
