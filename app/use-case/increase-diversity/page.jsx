      ...
      <section className="mt-24 mb-40">
        <div className="text-center mb-16 px-4">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Attract more shoppers by using Botika`s AI models to show off trendy
      ...
      <section className="bg-gray-50 py-24 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h2 className="text-4xl text-black font-bold mb-6 leading-snug">
            “Using Botika`s AI models has transformed our approach to fashion
            photography.”
          </h2>
      ...
      <section className="w-full bg-white py-24 px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-semibold leading-tight text-gray-900">
            How fashion brands increase diversity using Botika?
          </h2>
