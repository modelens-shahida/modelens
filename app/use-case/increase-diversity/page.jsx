  ...
  const sections = [
    {
      ...
      image:
        "https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/676a72dfea5023dd36eb93fd_Botika_UseCases_IncreaseDiversity_UnlockMoreModelVariety.avif",
    },
    {
      id: 1,
      ...
      image:
        "https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/67710435b3647a8250137b92_Botika_UseCases_IncreaseDiversity_ChangeBackgrounds.avif",
    },
    {
      id: 2,
      ...
      image:
        "https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/676a72a34f4b1c3ac35992d4_Botika_UseCases_IncreaseDiversity_Appealtomorecustomers.avif",
    },
    {
      id: 3,
  ...
  return (
    <div className="pt-20">
      ...
      <section className="text-center max-w-3xl mx-auto px-4 mt-10">
        <h1 className="text-4xl text-black font-bold mb-4">Increase Diversity</h1>
        <p className="text-lg text-gray-600 mb-6">
          Create the perfect scene with diverse AI models and settings. Easily
          switch up models and moods to connect with a wider audience.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-4 mt-10">
        <Image
          src="https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/684a0bf4e9432f8b9030e85f_Botika_UseCases_IncreaseDiversity_Header.webp"
      ...
      <section className="mt-24 mb-40">
        <div className="text-center mb-16 px-4">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Attract more shoppers by using ModeLens AI models to show off trendy
            styles, and allow your customers to see themselves in your designs.
          </p>
        </div>
      ...
      <section className="bg-gray-50 py-24 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h2 className="text-4xl text-black font-bold mb-6 leading-snug">
            “Using ModeLens AI models has transformed our approach to fashion
            photography.”
          </h2>
          ...
          <div className="flex flex-col items-center gap-4">
            <Image
              ...
              className="object-contain"
            />
            <p className="text-lg text-black font-medium">Shaul Cohen</p>
            <p className="text-gray-500">
              Executive Vice President, <span className="font-semibold">Jordache</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-white py-24 px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-semibold leading-tight text-gray-900">
            How fashion brands increase diversity using ModeLens?
          </h2>
          <p className="text-lg text-gray-700">
            With our AI models fashion technology, brands easily achieve online
            success by:
          </p>
          <ul className="list-disc pl-5 text-gray-700 text-base space-y-3">
            <li>
              Creating diverse, localized looks for the same product across
              different markets or countries.
            </li>
            <li>Finding the best model for each product with easy A/B testing.</li>
            <li>
              Launching new categories or markets effortlessly, creating
              personalized looks and cutting out weeks of prep.
            </li>
          </ul>
        </motion.div>
        ...
        >
          <Image
            src="https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/677105684bccc35abac7118f_Botika_UseCases_IncreaseDiversity_Howfashionbrandsincreasediversity.avif"
      ...
      <section className="bg-[#1b1919] text-white py-20 px-8 md:px-20 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 max-w-5xl mx-auto">
          {[{ number: "10%", label: "Sales" },
            { number: "3x", label: "More options than standard shoots" },
            { number: "50%", label: "Time to market" }].map((item, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          {[
            ...
            >
              ...
              <div className="p-6 flex flex-col justify-between flex-1">
                ...
                <motion.a
                  href="#"
                  className="relative inline-block text-[#A855F7] font-medium after:content-[''] after:absolute after:w-0 after:h-[2px] after:left-0 after:-bottom-1 after:bg-[#A855F7] hover:after:w-full after:transition-all after:duration-300"
                >
                  Read more
                </motion.a>
              </div>
