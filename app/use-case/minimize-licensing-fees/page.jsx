  ...
  const sections = [
    {
      ...
      description:
        "No more dealing with agencies, contracts, or lawyers.",
      image:
        "https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/6771008e7c3c8331cf1893c8_Botika_UseCase_MinimizeLicensingFees_NoHiddenFees.avif",
    },
    {
      id: 1,
      ...
      image:
        "https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/677100a2796275bf61debebf_Botika_UseCase_MinimizeLicensingFees_UseYourPhotosAnywhereAnytime.avif",
    },
    {
      id: 2,
      ...
      image:
        "https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/677100acfeec7013b39f6b66_Botika_UseCase_MinimizeLicensingFees_NoContracts.avif",
    },
    {
      id: 3,
  ...
  return (
    <div className="pt-20">
      ...
      <section className="text-center max-w-3xl mx-auto px-4 mt-10">
        <h1 className="text-4xl text-black font-bold mb-4">Minimize licensing fees</h1>
        <p className="text-lg text-gray-600 mb-6">
ModeLens makes photo management simple and cost-effective, so you don’t have to deal with confusing contracts or unexpected licensing fees.        </p>
      ...
      <div className="max-w-6xl mx-auto px-4 mt-10">
        <Image
          src="https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/6770feab26f9f2bb9a732da2_Botika_UseCase_MinimizeLicensingFees_Header.avif"
          alt="ready-to-post-social-images"
          width={1600}
          height={800}
...
Why fashion brands use ModeLens to simplify their licensing fees.          </p>
        </div>
      ...
      <section className="bg-gray-50 py-24 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h2 className="text-2xl text-black font-bold mb-6 leading-snug">
           The best AI model generator!
          </h2>
          <p className="text-gray-700 text-lg max-w-3xl mx-auto mb-10">
           Great experience so far, the customer service and support on this app is unmatched. Overall this has been a big cost saver for us with models and if the app keeps developing , it can only get better 
          </p>
      ...
      <section className="w-full bg-white py-24 px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          <Image
            src="https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/677100bcb8ade37f2f3d1985_Botika_UseCase_MinimizeLicensingFees_HowFashionBrandsMinimizingLicensingFees.avif"
...
export default MinimizeLicenscingFees;
