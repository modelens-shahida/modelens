  ...
  const sections = [
    {
      ...
      image:
        "https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/677101199492cb74eb62a73b_Botika_UseCases_ReadytoPostSocialImages_ImagesThatFitJustRight.avif",
    },
    {
      id: 1,
      ...
      image:
        "https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/67710214e0e51fd9b81107da_Botika_UseCases_ReadytoPostSocialImages_EffortlesslyCraftMultipleQualityImages.avif",
    },
    {
      id: 2,
      ...
      image:
        "https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/677676a169b390b3312c328a_Botika_UseCases_ReadytoPostSocialImages_Seewhichproductimagesworkbest.avif",
    },
    {
      id: 3,
  ...
  return (
    <div className="pt-20">
      ...
      <section className="text-center max-w-3xl mx-auto px-4 mt-10">
        <h1 className="text-4xl text-black font-bold mb-4">Ready to post social images</h1>
        <p className="text-lg text-gray-600 mb-6">
        ModeLens makes social media marketing a breeze. Export images that fit perfectly to all your digital channels` marketing campaigns.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-4 mt-10">
        <Image
          src="https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/677676896bba83fee2eed74c_Botika_UseCase_ReadytoPostSocialImages_Header.avif"
...
Sizing images for social media is a hassle. With ModeLens, export perfectly sized images in one click.          </p>
        </div>
      ...
      <section className="w-full bg-white py-24 px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          <Image
            src="https://cdn.prod.website-files.com/66faa4f99edc33598569d98f/6771023a4170e7aa6bff8de1_Botika_UseCases_ReadytoPostSocialImages_HowFashionBrandsBoostDigitalPresence.avif"
...
export default ReadyToPostSocialImages;
