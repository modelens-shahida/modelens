...
class GhostJob(Base):
    ...
    total_skus: Mapped[Optional[int]] = mapped_column(Integer, default=1)
    completed_skus: Mapped[Optional[int]] = mapped_column(Integer, default=0)
    failed_skus: Mapped[Optional[int]] = mapped_column(Integer, default=0)
    quality_mode: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
